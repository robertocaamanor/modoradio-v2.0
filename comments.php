...
<div id="comments">
	...
	$comments_arg = array(
		...
		'fields' => apply_filters( 'comment_form_default_fields', array(
				'autor' 				=> '<div class="form-group">' . '<label for="author">' . __( 'Nombre', 'wp_babobski' ) . '</label> ' . ( $req ? '<span>*</span>' : '' ) .
				...
				'url'					=> '')),
				'comment_field'			=> '<div class="form-group">' . '<label for="comment">' . __( 'Comentario', 'wp_babobski' ) . '</label><span>*</span>' .
